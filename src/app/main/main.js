                ...
                return (
                    <div key={index}>
                        ...
                        <div class="block rounded-lg shadow-lg  bg-neutral-700 text-center">
                            ...
                            <center>
                                <a href="#!">
                                <img class="t-lg" style={{height:250}} src={item.attributes.cover.data != null ? item.attributes.cover.data.attributes.url : "https://www.svgrepo.com/show/475352/book.svg"} alt=""/>
                                </a>
                            </center>
